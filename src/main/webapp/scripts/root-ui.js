...
GuacamoleRootUI.sections.login_form.onsubmit = function() {
    var url = 'client.xhtml?protocol=vnc&id=1';
    url = url + '&hostname=' + GuacamoleRootUI.fields.hostname.value;
    url = url + '&port=' + GuacamoleRootUI.fields.port.value;
    url = url + '&password=' + GuacamoleRootUI.fields.password.value;
